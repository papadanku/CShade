...
/* Textures & Samplers */
    ...
    CSHADE_CREATE_SAMPLER(SampleMotionVectorTex, CShade_Mainframe_MotionVectors, SHADER_MOTION_VECTORS_SAMPLING, SHADER_MOTION_VECTORS_SAMPLING, LINEAR, CLAMP, CLAMP, CLAMP)
#else
