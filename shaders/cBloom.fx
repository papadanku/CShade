...
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_0, CSHADE_BUFFER_SIZE_0, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_1, CSHADE_BUFFER_SIZE_1, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_2, CSHADE_BUFFER_SIZE_2, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_3, CSHADE_BUFFER_SIZE_3, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_4, CSHADE_BUFFER_SIZE_4, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_5, CSHADE_BUFFER_SIZE_5, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_6, CSHADE_BUFFER_SIZE_6, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_7, CSHADE_BUFFER_SIZE_7, RGBA16F, 1)
CSHADE_CREATE_TEXTURE_POOLED(SharedTex_RGBA16F_8, CSHADE_BUFFER_SIZE_8, RGBA16F, 1)

CSHADE_CREATE_SAMPLER(SampleSharedTex0, SharedTex_RGBA16F_0, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex1, SharedTex_RGBA16F_1, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex2, SharedTex_RGBA16F_2, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex3, SharedTex_RGBA16F_3, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex4, SharedTex_RGBA16F_4, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex5, SharedTex_RGBA16F_5, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex6, SharedTex_RGBA16F_6, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex7, SharedTex_RGBA16F_7, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
CSHADE_CREATE_SAMPLER(SampleSharedTex8, SharedTex_RGBA16F_8, LINEAR, LINEAR, LINEAR, CLAMP, CLAMP, CLAMP)
...
>
{
    TEMPLATE_PASS(Prefilter, CShade_VS_Quad, PS_Prefilter, SharedTex_RGBA16F_0, FALSE)

    // Iteratively downsample the image (RGB) and its log luminance (A) into a pyramid.
    TEMPLATE_PASS(Downsample1, CShade_VS_Quad, PS_Downscale1, SharedTex_RGBA16F_1, FALSE)
    TEMPLATE_PASS(Downsample2, CShade_VS_Quad, PS_Downscale2, SharedTex_RGBA16F_2, FALSE)
    TEMPLATE_PASS(Downsample3, CShade_VS_Quad, PS_Downscale3, SharedTex_RGBA16F_3, FALSE)
    TEMPLATE_PASS(Downsample4, CShade_VS_Quad, PS_Downscale4, SharedTex_RGBA16F_4, FALSE)
    TEMPLATE_PASS(Downsample5, CShade_VS_Quad, PS_Downscale5, SharedTex_RGBA16F_5, FALSE)
    TEMPLATE_PASS(Downsample6, CShade_VS_Quad, PS_Downscale6, SharedTex_RGBA16F_6, FALSE)
    TEMPLATE_PASS(Downsample7, CShade_VS_Quad, PS_Downscale7, SharedTex_RGBA16F_7, FALSE)
    TEMPLATE_PASS(Downsample8, CShade_VS_Quad, PS_Downscale8, SharedTex_RGBA16F_8, FALSE)

    /*
        Additive iterative upsampling.
        Formula: Upsample(Level[N+1]) + Level[N]
    */
    TEMPLATE_PASS(Upscale7, CShade_VS_Quad, PS_Upscale7, SharedTex_RGBA16F_7, TRUE)
    TEMPLATE_PASS(Upscale6, CShade_VS_Quad, PS_Upscale6, SharedTex_RGBA16F_6, TRUE)
    TEMPLATE_PASS(Upscale5, CShade_VS_Quad, PS_Upscale5, SharedTex_RGBA16F_5, TRUE)
    TEMPLATE_PASS(Upscale4, CShade_VS_Quad, PS_Upscale4, SharedTex_RGBA16F_4, TRUE)
    TEMPLATE_PASS(Upscale3, CShade_VS_Quad, PS_Upscale3, SharedTex_RGBA16F_3, TRUE)
    TEMPLATE_PASS(Upscale2, CShade_VS_Quad, PS_Upscale2, SharedTex_RGBA16F_2, TRUE)
    TEMPLATE_PASS(Upscale1, CShade_VS_Quad, PS_Upscale1, SharedTex_RGBA16F_1, TRUE)
