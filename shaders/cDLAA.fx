...
void PS_Prefilter(CShade_VS2PS_Quad Input, out float4 Output : SV_TARGET0)
{
    ...
    float3 Center = tex2Dlod(CShade_SampleGammaTex, CShade_PadFloat2(Input.Tex0)).rgb;
    Neighborhood[0] = tex2Dlod(CShade_SampleGammaTex, CShade_PadFloat2(EdgeTex0.xy)).rgb;
    Neighborhood[1] = tex2Dlod(CShade_SampleGammaTex, CShade_PadFloat2(EdgeTex0.zw)).rgb;
    Neighborhood[2] = tex2Dlod(CShade_SampleGammaTex, CShade_PadFloat2(EdgeTex1.xy)).rgb;
    Neighborhood[3] = tex2Dlod(CShade_SampleGammaTex, CShade_PadFloat2(EdgeTex1.zw)).rgb;
...
void PS_Main(CShade_VS2PS_Quad Input, out float4 Output : SV_TARGET0)
{
    ...
    float4 Center = tex2Dlod(CShade_SampleGammaTex, CShade_PadFloat2(Input.Tex0));
    ...
    float4 Left = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(ShortTex1.xy));
    float4 Right = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(ShortTex1.zw));
    float4 Top = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(ShortTex2.xy));
    float4 Bottom = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(ShortTex2.zw));
    ...
    float4 H0 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex0.xy));
    float4 H1 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex1.xy));
    float4 H2 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex2.xy));
    float4 H3 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex3.xy));
    float4 H4 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex4.xy));
    float4 H5 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex5.xy));
    float4 H6 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex6.xy));
    float4 H7 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex7.xy));

    float4 V0 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex0.zw));
    float4 V1 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex1.zw));
    float4 V2 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex2.zw));
    float4 V3 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex3.zw));
    float4 V4 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex4.zw));
    float4 V5 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex5.zw));
    float4 V6 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex6.zw));
    float4 V7 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(LongTex7.zw));
    ...
    */
    ...
    if (_PreserveFrequencies)
    {
        ...
        float4 R0 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(RTex.xw));
        float4 R1 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(RTex.zw));
        float4 R2 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(RTex.xy));
        float4 R3 = tex2Dlod(SampleSharedTex0, CShade_PadFloat2(RTex.zy));
