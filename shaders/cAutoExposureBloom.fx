...
// Inject cCamera.fxh
#ifndef SHADER_TOGGLE_AUTO_EXPOSURE
    #define SHADER_TOGGLE_AUTO_EXPOSURE 1
#endif
#define CCAMERA_TOGGLE_AUTO_EXPOSURE SHADER_TOGGLE_AUTO_EXPOSURE
...
// Inject cComposite.fxh
    ...
    #define SHADER_TOGGLE_TONEMAP 1
#endif
...
void PS_Main(CShade_VS2PS_Quad Input, out float4 Output : SV_TARGET0)
{
    ...
    // Apply (optional) vignette
        ...
        CLens_ApplyFilmGrain(Color, Input.HPos.xy, _CLens_GrainScale, _CLens_GrainAmount, _CLens_GrainSeed);
    #endif
